class movie:
    ...
    def calculate_net_profit(self): #new function to calculate net profit
        if self.revenue == 0:
            return 0.0
        return self.expenses / self.revenue #expenses/revenue=net profit
...
DDLJ=movie(title="DDLJ", genre="romance", expenses=10000, revenue=50000)
K3G= movie(title="K3G", genre="romcom", expenses=250000, revenue=800000)
